        ...
        while True:
            if len(senha) < 6:
                ...
                if confirmarSenha == senha:
                    print(f'Cadastro concluido, seja bem vindo {nome}!')
                    break
                else:
    ...
    if len(usuarios_cadastrados) == 0:
        ...
        while True:
            ...
            for k, v in usuarios_cadastrados.items():
                while k == emailLogin:
                    if v[0] == senhaLogin:
                        print(f'Olá {v[1]}, login efetuado.')
                        break
                    else:
                        ...
                        while True:
                            ...
                            if '@' not in NovoEmail:
                                ...
                                if confirmarEmail == NovoEmail:
                                    print(f'Seu email foi alterado com sucesso!')
...
def testePython():
    ...
    while True:
        try:
            ...
            print("Digite uma opção valida")
    print(167 * "=")
    print(f'Parabens você acertou {cont} questões!' if cont > 2 else f'Poxa você acertou {cont} questões!')
